...
import CreateTodoAction from '@components/todo/createTodoAction'
...
function EmptyView(props: {todos: Todo[]; filter: Filter; searchText: string; onCreate: (title: string) => void}) {
    ...
    switch (props.filter) {
        ...
        case Filter.Completed: {
            return <List.EmptyView icon="😢" title="No todos completed" description="Uh-oh, looks like you haven't completed any todos yet." />
        }
        case Filter.All:
        default: {
            return (
