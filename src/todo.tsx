...
import {Filter, Todo} from '@src/types'
import {CreateTodoAction, DeleteTodoAction, EmptyView, ToggleTodoAction} from '@components/todo'
...
export default function Command() {
    ...
    return (
        <List
            ...
            searchBarAccessory={
                <List.Dropdown tooltip="Select Todo List" value={state.filter} onChange={newValue => setState(previous => ({...previous, filter: newValue as Filter}))}>
